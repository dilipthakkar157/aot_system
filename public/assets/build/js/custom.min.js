! function(e) {
    jQuery.fn[e] = function(a) {
        return a ? this.bind("resize", (t = a, function() {
            var e = this,
                a = arguments;
...
function init_sidebar() {
    ...
    $SIDEBAR_MENU.find("a").on("click", function(t) {
        var o = $(this).parent();
        o.is(".active") ? (o.removeClass("active active-sm"), $("ul:first", o).slideUp(function() {
            e()
        })) : (o.parent().is(".child_menu") ? $BODY.is("nav-sm") && (o.parent().is("child_menu") || a()) : a(), o.addClass(""), $("ul:first", o).slideDown(function() {
            e()
        }))
    }), $MENU_TOGGLE.on("click", function() {
        $(".header-logo").toggleClass("minimize-logo"), $BODY.hasClass("nav-md") ? ($SIDEBAR_MENU.find("li.active ul").hide(), $SIDEBAR_MENU.find("li.active").addClass("active-sm").removeClass("active")) : ($SIDEBAR_MENU.find("li.active-sm ul").show(), $SIDEBAR_MENU.find("li.active-sm").addClass("active").removeClass("active-sm")), $BODY.toggleClass("nav-md nav-sm"), e(), $(".dataTable").each(function() {
        ...
        e()
    }).parent().addClass(""), $(window).smartresize(function() {
        e()
    ...
    if (void 0 !== $.fn.cropper) {
        ...
        var e = $("#image"),
            ...
            c = {
                ...
                preview: ".img-preview",
                crop: function(e) {
                    t.val(Math.round(e.x)), o.val(Math.round(e.y)), n.val(Math.round(e.height)), i.val(Math.round(e.width)), r.val(e.rotate), l.val(e.scaleX), s.val(e.scaleY)
                }
            };
        ...
        }).cropper(c), $.isFunction(document.createElement("canvas").getContext) || $('button[data-method="getCroppedCanvas"]').prop("disabled", !0), void 0 === document.createElement("cropper").style.transition && ($('button[data-method="rotate"]').prop("disabled", !0), $('button[data-method="scale"]').prop("disabled", !0)), void 0 === a[0].download && a.addClass("disabled"), $(".docs-toggles").on("change", "input", function() {
            var a, t, o = $(this),
                n = o.attr("name"),
                i = o.prop("type");
            e.data("cropper") && ("checkbox" === i ? (c[n] = o.prop("checked"), a = e.cropper("getCropBoxData"), t = e.cropper("getCanvasData"), c.built = function() {
                e.cropper("setCropBoxData", a), e.cropper("setCanvasData", t)
            }) : "radio" === i && (c[n] = o.val()), e.cropper("destroy").cropper(c))
        }), $(".docs-buttons").on("click", "[data-method]", function() {
            var t, o, n = $(this),
                i = n.data();
            if (!n.prop("disabled") && !n.hasClass("disabled") && e.data("cropper") && i.method) {
                if (void 0 !== (i = $.extend({}, i)).target && (t = $(i.target), void 0 === i.option)) try {
                    i.option = JSON.parse(t.val())
                } catch (t) {
                    console.log(t.message)
                }
                switch (o = e.cropper(i.method, i.option, i.secondOption), i.method) {
                    case "scaleX":
                    case "scaleY":
                        $(this).data("option", -i.option);
                        break;
                    case "getCroppedCanvas":
                        o && ($("#getCroppedCanvasModal").modal().find(".modal-body").html(o), a.hasClass("disabled") || a.attr("href", o.toDataURL()))
                }
                if ($.isPlainObject(o) && t) try {
                    t.val(JSON.stringify(o))
                } catch (t) {
                    console.log(t.message)
                }
            }
        }), $(document.body).on("keydown", function(a) {
            if (e.data("cropper") && !(300 < this.scrollTop)) switch (a.which) {
                case 37:
        ...
        m ? u.change(function() {
            var a, t = this.files;
            e.data("cropper") && t && t.length && (a = t[0], /^image\/\w+$/.test(a.type) ? (d = m.createObjectURL(a), e.one("built.cropper", function() {
                m.revokeObjectURL(d)
            }).cropper("reset").cropper("replace", d), u.val("")) : window.alert("Please choose an image file."))
...
function init_EasyPieChart() {
    if (void 0 !== $.fn.easyPieChart) {
        ...
        $.fn.popover.Constructor.prototype.leave = function(e) {
            var t, o, n = e instanceof this.constructor ? e : $(e.currentTarget)[this.type](this.getDelegateOptions()).data("bs." + this.type);
            a.call(this, e), e.currentTarget && (t = $(e.currentTarget).siblings(".popover"), o = n.timeout, t.one("mouseenter", function() {
...
function init_charts() {
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
        ...
        $("#canvasRadar").length && (e = document.getElementById("canvasRadar"), a = {
            ...
            type: "radar",
            data: a
        })), $("#pieChart").length && (e = document.getElementById("pieChart"), a = {
            datasets: [{
                data: [120, 50, 140, 180, 100],
                backgroundColor: ["#455C73", "#9B59B6", "#BDC3C7", "#26B99A", "#3498DB"],
                label: "My dataset"
        ...
        })), $("#polarArea").length && (e = document.getElementById("polarArea"), a = {
            datasets: [{
                data: [120, 50, 140, 180, 100],
                backgroundColor: ["#455C73", "#9B59B6", "#BDC3C7", "#26B99A", "#3498DB"],
                label: "My dataset"
    ...
    if (void 0 !== $.fn.fullCalendar) {
        ...
        var e, a = new Date,
            ...
            i = $("#calendar").fullCalendar({
                ...
                selectable: !0,
                selectHelper: !0,
                select: function(a, t, o) {
                    $("#fc_create").click(), e = a, ended = t, $(".antosubmit").on("click", function() {
                        var a = $("#title").val();
                        return t && (ended = t), $("#event_type").val(), a && i.fullCalendar("renderEvent", {
                            title: a,
                            start: e,
                            end: t,
                            allDay: o
...
function init_DataTables() {
    if (console.log("run_datatables"), void 0 !== $.fn.DataTable) {
        console.log("init_DataTables"), TableManageButtons = function() {
            "use strict";
            return {
                init: function() {
